...
@pytest.mark.asyncio
async def test_register_view_route(page_context):
...
@pytest.mark.asyncio
async def test_register_view_contains_fields(page_context):
    view = await register_view(page_context)
...
@pytest.mark.asyncio
async def test_register_view_contains_register_button(page_context):
    view = await register_view(page_context)

...
Define requirements for the refactored route handler in CousCous, replacing the long if/elif chain with a declarative route table and centralized context factory.

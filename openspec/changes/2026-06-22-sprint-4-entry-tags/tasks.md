...
- [x] 1.2 Fazer commit dos artefatos de planejamento (`git add openspec/changes/2026-06-22-sprint-4-entry-tags/ && git commit -m "docs(planning): gera artefatos do sprint 4 entry tags"`)
...
- [x] 2.3 Fazer commit do modelo (`git add database/models/couscous.py && git commit -m "feat(data): substitui FeedTag por EntryTag com escopo de usuario"`)
...
- [x] 3.3 Fazer commit do service (`git add app/services/tag_service.py app/services/entry_service.py && git commit -m "feat(service): adiciona tag_service com CRUD e filtro por tag em entry_service"`)
...
- [x] 4.2 Fazer commit do componente (`git add app/controls/tag_chip.py && git commit -m "feat(ui): cria componente TagChip reutilizavel"`)
...
- [x] 5.3 Fazer commit da exibição nos cards (`git add app/controls/article_card.py app/views/entry_list_view.py && git commit -m "feat(ui): exibe tags nos ArticleCards da lista de entries"`)
...
- [x] 6.4 Fazer commit da interface de tags na entry view (`git add app/views/entry_view.py && git commit -m "feat(ui): adiciona gerenciamento de tags inline na tela de detalhe"`)
...
- [x] 7.4 Fazer commit do filtro por tag (`git add app/views/entry_list_view.py && git commit -m "feat(ui): adiciona filtro por tag na lista de entries"`)
...
- [x] 8.3 Fazer commit dos testes (`git add tests/ && git commit -m "test: adiciona testes para tag_service e filtro por tag"`)
...
- [x] 9.7 Fazer commit final de ajustes de QA (`git commit -m "chore: ajustes finais de qualidade e validacao manual"`)
